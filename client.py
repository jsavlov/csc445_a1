...
lat1_tx_time = send_latency(1, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
lat1_rx_time = receive_latency(1, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
...
lat32_tx_time = send_latency(32, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
lat32_rx_time = receive_latency(32, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
...
lat1024_tx_time = send_latency(1024, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
lat1024_rx_time = receive_latency(1024, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
...
tp1k_tx_rate = calc_throughput(1000, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
print "Throughput 1 Kbyte result: " + str(float("%.5f" % (tp1k_tx_rate / 1000000))) + " MB/s"

host_socket = fresh_client_socket(HOST_SERVER, PORT, using_udp)
print "Throughput test: 16 KBytes"
tp16k_tx_rate = calc_throughput(16000, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
print "Throughput 16 Kbyte result: " + str(float("%.5f" % (tp16k_tx_rate / 1000000))) + " MB/s"

host_socket = fresh_client_socket(HOST_SERVER, PORT, using_udp)
print "Throughput test: 64 KBytes"
tp64k_tx_rate = calc_throughput(64000, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
print "Throughput 64 Kbyte result: " + str(float("%.5f" % (tp64k_tx_rate / 1000000))) + " MB/s"

host_socket = fresh_client_socket(HOST_SERVER, PORT, using_udp)
print "Throughput test: 256 KBytes"
tp256k_tx_rate = calc_throughput(256000, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
print "Throughput 256 Kbyte result: " + str(float("%.5f" % (tp256k_tx_rate / 1000000))) + " MB/s"

host_socket = fresh_client_socket(HOST_SERVER, PORT, using_udp)
print "Throughput test: 1 MBytes"
tp1m_tx_rate = calc_throughput(1000000, host_socket, HOST_SERVER if using_udp else None, PORT if using_udp else None)
